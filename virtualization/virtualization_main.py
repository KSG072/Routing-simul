...
from utils.loader import load_ground_relays_from_csv, prepare_node_routing_metadata
...
class EarthApp(ShowBase):
    def __init__(self):
        ...
        for ground in ground_relays:
            ground = prepare_node_routing_metadata(ground, mapper, 550)
